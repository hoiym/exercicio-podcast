...
public class PodcastDBHelper extends SQLiteOpenHelper {
    ...
    public final static String EPISODE_AUDIO_STATE = "audioState";
    public final static String EPISODE_BUTTON_STATE = "buttonState";

    public final static String[] columns = {
            _ID, EPISODE_TITLE, EPISODE_DATE, EPISODE_LINK,
            EPISODE_DESC, EPISODE_DOWNLOAD_LINK, EPISODE_FILE_URI,
            EPISODE_AUDIO_STATE, EPISODE_BUTTON_STATE
    };
    final private static String CREATE_CMD =
            "CREATE TABLE "+DATABASE_TABLE+" (" + _ID
                    ...
                    + EPISODE_AUDIO_STATE + " TEXT NOT NULL, "
                    + EPISODE_BUTTON_STATE + " TEXT NOT NULL)";
